...
## Checklist
1. Compare current implementation in `src/components/VueModalDialog.vue` and `src/index.js` against `README.md` and `src/components/VueModalDialog.stories.js`.
2. Detect mismatches in props, emits, slots, defaults, and usage examples.
3. Update docs/stories to match real behavior.
4. Preserve project tone and existing structure of each documentation file.
